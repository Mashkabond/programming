...
public class Theory {
    public static void main(String[] args) {
        ...
        // Это значит, что тип переменной указывается один раз при объявлении и не может меняться дальше в программе.
        int age = 25;
        ...
        // Этот тип данных пишется с большой буквы. А значение задается в двойных кавычках " ".
        ...
        // snake_case НЕ используется в Java (только для констант, которые будут рассмотрены позже)
